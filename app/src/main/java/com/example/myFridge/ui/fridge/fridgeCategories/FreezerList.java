...
public class FreezerList {
    ...
    public FreezerList() {
        ...
        FreezerList.addItem("Frozen Pizza",11, LocalDate.of(2020,1,8));
        FreezerList.addItem("Frozen Hot Dog",22, LocalDate.of(2020,3,8));
        FreezerList.addItem("Frozen Dumplings",33, LocalDate.of(2020,2,8));
        FreezerList.addItem("Frozen Pie",44, LocalDate.of(2020,2,8));
        FreezerList.addItem("Ice Cream",55, LocalDate.of(2020,2,8));
        FreezerList.addItem("Bacon",66, LocalDate.of(2020,2,8));
        FreezerList.addItem("Pork belly",77, LocalDate.of(2020,2,8));
